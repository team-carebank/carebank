...
public class MeditationDto {
	...
	public MeditationDto(int meditate_id, int subcat_id, String subcat_name, String med_title, String med_thum,
			String med_url_play, String med_url_playlist1, String med_url_playlist2, String med_url_playlist3,
			String med_quote) {
		super();
