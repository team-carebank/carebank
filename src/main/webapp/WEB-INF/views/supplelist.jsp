...
<script src="${pageContext.request.contextPath }/resources/js/supple.js"></script>
</head>
	...
	<div class="container">
		<div class="body-content">
			...
			<div class="content-main">
				<div class="content-desc">
					<div>
						<span><b class="sub-category-name"></b>을 위한 영양제 정보를 알려드립니다.</span>
					</div>
					<br>
				</div>
