...
<script type="text/javascript">
  ...
  function drawChart() {
    ...
    // 차트 실행
    var chart = new google.charts.Bar(document.getElementById('columnchart_nutrient'));
...
<script type="text/javascript">
  ...
  function drawChart() {
    ...
    var chart = new google.visualization.LineChart(document.getElementById('curve_chart_bmi'));
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <div class="bmi">
                <span >
                  <a href="dashboard_bmi.html" id="bmi"> bmi </a>
                </span>
            ...
            <div class=" col-sm-6">
              <div class="mind">
                <span>
                  <a href="dashboard_mind.html"> 마음건강 </a>
                </span>
                <br>
                <br>
                <img src="" />
                <span>이번주는 ___ 가 가득하네요~</span>
              </div>
            </div>
          </div>
          <br>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="nutrient">
                <span>
                  <a href="dashboard_nutrient.html">영양소</a>
                </span>
            ...
            <div class=" col-sm-6">
              <div class="heath">
                <span>
                  <a href="dashboard_ health.html">운동</a>
                </span>
